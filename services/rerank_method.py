"""
Reranking Helper Methods
Helper functions for reranking diagnosis results
"""
...
def rerank_combined_results(diagnoses: List[Dict], normalized_data: Dict) -> List[Dict]:
    """
